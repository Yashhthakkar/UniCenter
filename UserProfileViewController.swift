...
class UserProfileViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    var likedUserIDs: Set<String> = [] // Set of liked user IDs
    ...
    func displayOverlayImages(for index: Int) {
        ...
        // Assigning the tappedImage to overlayCenterImageView
        ...
        // Setup the overlayBottomImageView (next image)
        ...
        // Adding swipe gestures for the overlay
