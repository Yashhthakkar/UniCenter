...
class HomeViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        menuTableView.isHidden = true  // Start with the menu hidden
    ...
    private func setupCollectionView() {
        ...
        layout.itemSize = CGSize(width: view.frame.width - 40, height: 400) // Example size, adjust as needed
        ...
        NSLayoutConstraint.activate([
            collectionView.topAnchor.constraint(equalTo: userCardsScrollView.bottomAnchor), // Change this line
            collectionView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            collectionView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20),
            collectionView.heightAnchor.constraint(equalToConstant: 0) // Change this line to set its height to 0
        ])
    }
    ...
    func updateUIWithRecommendation(user: RecommendationAlgorithm.UserProfile, posts: [RecommendationAlgorithm.Post]) {
        ...
        // Common constraints for userCard, profileImageView, and nameLabel
        NSLayoutConstraint.activate([
    ...
    @objc func ellipsisButtonTapped(_ sender: UIButton) {
        ...
        paneView.tag = 101 // Use a unique tag to identify the pane view later
        ...
        // Create and add the report button
        ...
        // Create an overlay button to detect taps outside the pane view
        ...
        if buttonTag >= 0 && buttonTag < recommendedProfiles.count {
            ...
            reportedUserID = reportedUser.uid // Set the reportedUserID based on the selected user
        } else {
            print("Error: Button tag is invalid or out of range")
            return
        }

        // Add the pane view on top of the overlay button
        self.view.addSubview(paneView)

        // Animate the pane view sliding up
    ...
    private func checkForMutualLike(currentUserID: String, likedUserID: String) {
        // Fetch the attractedTo list of the liked user
    ...
    private func addSpeechBlockToUserCard(_ heartIcon: UIImageView, _ userCard: UIView) {
        ...
        // Automatically dismiss Speech Block after 2 seconds
