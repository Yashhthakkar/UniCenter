...
class EditProfileViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    @objc func genderDonePressed() {
        let selectedGender = genderOptions[genderPicker.selectedRow(inComponent: 0)]
    ...
    @objc func fitnessLevelDonePressed() {
        fitnessLevelTextField.text = fitnessLevelOptions[fitnessLevelPicker.selectedRow(inComponent: 0)]
        view.endEditing(true)
    }
    
    @objc func raceDonePressed() {
        raceTextField.text = raceOptions[racePicker.selectedRow(inComponent: 0)]
        view.endEditing(true)
    }
    
    @objc func religionDonePressed() {
        religionTextField.text = religionOptions[religionPicker.selectedRow(inComponent: 0)]
        view.endEditing(true)
    }
    
    @objc func yearDonePressed() {
        yearTextField.text = yearOptions[yearPicker.selectedRow(inComponent: 0)]
        view.endEditing(true)
    }
}
