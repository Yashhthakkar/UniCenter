...
class SpeechBlockView: UIView {
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            ...
            messageLabel.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -5), // Adjusted for tail height
        ...
        // Setup the tailView as a triangle using CAShapeLayer
        setupTailView()
    }
