...
class ProfileViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    let sliderWidth: CGFloat = 3.0 // Width of the slider
    let sliderHeight: CGFloat = 100.0 // Total height of the slider track
    ...
    func setupSlider() {
        ...
        if let overlayImage = overlayCenterImageView?.image, let currentImageIndex = userPosts.firstIndex(where: { $0.image == overlayImage }) {
            ...
            // Initialize and configure the indicator view
    ...
    @objc func handleOverlaySwipeDown() {
        ...
        if let currentImage = overlayCenterImageView.image,
           ...
           index > 0 {
            ...
            // Check if overlayBottomImageView exists
...
extension ProfileViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func displayOverlayImages(for index: Int) {
        ...
        // Adding a Semi-Transparent Background View
